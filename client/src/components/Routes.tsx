...
import { Settings as AdminSettings } from './admin/settings/Settings';
...
const userIsAuthenticated = connectedRouterRedirect({
    redirectPath: '/login',
    authenticatedSelector: (state: any) => state !== null && state.user !== null && state.user.data !== null,
    wrapperDisplayName: 'UserIsAuthenticated',
});

const userIsNotAuthenticated = connectedRouterRedirect({
    redirectPath: (state: any, ownProps: any) => locationHelper.getRedirectQueryParam(ownProps) || '/',
    allowRedirectBack: false,
    authenticatedSelector: (state: any) => state.user.data === null,
