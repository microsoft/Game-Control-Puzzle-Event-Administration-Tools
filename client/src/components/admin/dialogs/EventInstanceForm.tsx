    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <FormGroup>
                ...
                <Datetime value={moment.utc(startTime).local()}
                          onChange={value => isMoment(value) && setStartTime(moment.utc(value))}
                />
            </FormGroup>
            <FormGroup>
                <Form.Label>End Time</Form.Label>
                <Datetime value={moment.utc(endTime).local()}
                    ...
                    <Form.Control
                        ...
                        <option value={'none'}>None</option>
                        {
                            eventInstances.map(eventInstance => 
                                <option key={eventInstance.eventInstanceId} value={eventInstance.eventInstanceId}>{eventInstance.friendlyName}</option>
                        )}
                    </Form.Control>
                </FormGroup>
            }
