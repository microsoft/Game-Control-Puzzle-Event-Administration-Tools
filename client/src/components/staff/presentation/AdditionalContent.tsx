...
const LocationContent = ({ content }: ContentProps) => {
    ...
    const bingMapsUrlLatLong = `https://www.bing.com/maps/default.aspx?lvl=18&cp=${content.latitude}~${content.longitude}&sp=point.${content.latitude}_${content.longitude}_Location`;
