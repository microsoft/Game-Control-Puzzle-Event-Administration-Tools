  ...
  return (
    <div>
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div>
            <strong>{feedItem.teamName}</strong> unlocked{" "}
            <strong>{feedItem.description}</strong>
          </div>
        </Col>
        <Col xs={4} md={4} style={{ textAlign: "right" }}>
          <div>
...
const PulseFeedItem = ({ feedItem }: FeedItemProps) => {
  ...
  switch (feedItem.numericValue) {
    case 1: sentiment = <FaRegAngry size="32px" />; break;
    case 2: sentiment = <FaSadTear size="32px" />; break;
    case 3: sentiment = <FaRegMeh size="32px" />; break;
    case 4: sentiment = <FaSmile size="32px" />; break;
    case 5: sentiment = <FaRegSmileBeam size="32px" />; break;
  }
  ...
  return (
    <div>
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div>{sentiment}{feedItem.description}</div>
          <div>
...
const CallStartedFeedItem = ({ feedItem }: FeedItemProps) => {
  ...
  return (
    <div>
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div>{call.icon}{call.message}</div>
        </Col>
        <Col xs={4} md={4} style={{ textAlign: "right" }}>
          <div>
...
const SubmissionFeedItem = ({ feedItem }: FeedItemProps) => {
  ...
  return (
    <div>
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div style={{ color: submissionColor() }}>
      ...
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div style={{ verticalAlign: "center" }}>
            {feedItem.teamName} has been skipped over{" "}
            <strong>{feedItem.description}</strong>
          </div>
        </Col>
        <Col xs={4} md={4} style={{ textAlign: "right" }}>
  ...
  return (
    <div>
      <Row>
        <Col xs={8} md={8} style={{ textAlign: "left" }}>
          <div style={{ verticalAlign: "center" }}>
            <strong>{feedItem.description}</strong> has been unlocked for{" "}
            {feedItem.teamName}
          </div>
        </Col>
        <Col xs={4} md={4} style={{ textAlign: "right" }}>
