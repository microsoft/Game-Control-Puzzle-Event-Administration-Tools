...
export const AnswerForm = ({ answer, teams, onSubmit }: Props) => {
    ...
    const [isCorrect, setIsCorrect] = useState(answer?.isCorrectAnswer ?? false);
    ...
    const isHiddenValid = () => !isHidden || isCorrect;
        ...
        <>
            ...
            <FormGroup>
                ...
                <Form.Control type="text"
                    ...
                    onChange={event => setAnswerResponse(event.target.value)}
                />
            </FormGroup>
            <Form.Check
                type="checkbox"
                ...
                checked={isCorrect}
                onChange={(event: any) => setIsCorrect(event.target.checked)}
            />
            <Form.Check
                type="checkbox"
                label="Is Hidden Answer?"
                isInvalid={!isHiddenValid()}
                checked={isHidden}
                onChange={(event: any) => setIsHidden(event.target.checked)}
            />
