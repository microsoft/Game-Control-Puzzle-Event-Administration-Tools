    ...
    return (
        <>
            <Form.Group>
                ...
                <Form.Control type="text" value={title} placeholder="Clue Title" isInvalid={!isTitleValid()} onChange={(event) => setTitle(event.target.value)} />
                <Form.Control.Feedback type="invalid">Title cannot be null</Form.Control.Feedback>
            </Form.Group>
            <Form.Group>
                <Form.Label>Short Name</Form.Label>
                <Form.Control type="text" value={shortTitle} placeholder="Short Title" onChange={(event) => setShortTitle(event.target.value)} />
            </Form.Group>
            <Form.Group>
                <Form.Label>Clue Type</Form.Label>
                <Form.Control as="select" onChange={(event) => setSubmittableType(event.target.value)} value={submittableType}>
